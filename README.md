...
```powershell
.\scripts\build.ps1 -Clean -Deploy
```

For the Qt DLLs and getting the GUI:
```powershell
Set-Location qt
& "C:/Qt/6.11.1/msvc2022_64/bin/windeployqt.exe" --release --compiler-runtime "build/UMD_FileRenamer.exe"
```
